...
Arguments:
	...
	geneID_type -- type of gene identifier; type_1 = "compXX_cXX_seqXX", type_2="TRINITY_DNXXXXX_cX_gX_iX",
			type_3="SegXX.XX.XXXX", type_4="taepXX_DNXXgXX_itXX"", type_5="Isoform_XXXX-Partition_XXXX_X"
...
if geneID_type == "type_5":
    searchStr = "(transcript_.+-(Partition_.+_.+)) transcript.+"
    protein_searchStr = "(transcript_.+-(Partition_.+_.+).p\d+)"
